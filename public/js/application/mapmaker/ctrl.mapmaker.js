angular
    .module('mapmaker')
    .controller('MapmakerCtrl', ['$scope', '$timeout', 'MapService', 'AudioContextService', 'BufferService' , function($scope, $timeout, MapService, AudioContextService, BufferService) {
